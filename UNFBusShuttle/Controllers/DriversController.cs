...
namespace UNFBusShuttle.Controllers
{
    public class DriversController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("busNumber,schedId,status,Id,fName,lName,email,password,role")] Driver driver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("busNumber,schedId,status,Id,fName,lName,email,password,role")] Driver driver)
        {
            if (id != driver.Id)
            {
                return NotFound();
